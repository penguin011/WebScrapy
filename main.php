...
<div class="panel panel-default">
                        ...
                        <div class="panel-body log_users">
                            ...
                            <ul class="nav nav-tabs">
                                ...
                                <!--PENDIENTE -->        
                                <li><a href="#contacts" data-toggle="tab" style="display: none;" id="click_contacts">CONTACTS</a>                      </li>
                            ...
                            <div class="tab-content">
                                <div class="tab-panel fade DivWithScroll" id="contacts">
                                    <h4></h4>
                                    <?php  var_dump($_POST);  include './contacts.php' ?>
                                </div>
                                ...
                                <div class="tab-panel fade DivWithScroll" id="users">
                                    <h4></h4>
